 ...
 */
var starWarsChracters:[String:[String]] = [
 ...
 */
var starWarsGangsters = ["Watto", "Jabba the Hunt"]
 ...
 */
starWarsChracters.updateValue(starWarsGangsters, forKey: "Gangsters")
 ...
 */
for keys in starWarsChracters.keys {
    print(keys)
}
 ...
 */
if starWarsChracters.isEmpty {
    print ("The dictionary is empty!")
} else {
    print ("There are \(starWarsChracters.count) items in the dictionary")
}
 ...
 */
starWarsChracters.updateValue(starWarsJedi, forKey: "Jedi")

if let jedivalue = starWarsChracters["Jedi"] {
 ...
 */
if starWarsChracters.removeValueForKey("Bounty Hunters") != nil {
 ...
 */
print(starWarsChracters["Jedi"])

if var jedi = starWarsChracters["Jedi"] {
    jedi.append("Aayla Secura")
    
    starWarsChracters["Jedi"] = jedi
}
 ...
 */
var keysOfStarWars = Array(starWarsChracters.keys)

print(keysOfStarWars)

 if let heroes = starWarsChracters["Heroes"] {
    for hero in heroes  {
        print(hero)
 }
 }
